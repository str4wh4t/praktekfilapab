...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <link rel="icon" href="https://apps.usm.ac.id/akd/assets/frondend/images/ico/favicon.png">
    ...
    <body>
        ...
        <div class="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
            ...
            <a class="mr-5 hover:text-gray-900">Artikel</a>
            <a class="mr-5 hover:text-gray-900">Penulis</a>
            </nav>
